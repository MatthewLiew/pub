...
if ($_SESSION['login_user_role'] == '2') {
    ...
    if (isset($_POST['start_date'])) {
        ...
        $transaction_list = get_transaction_list_by_date($start_date, $end_date);
    } else {
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" id="Facility_Log" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                foreach ($transaction_list as $row) {
                                    ...
                                    if($row['action']=='open_gate_status')
                                        echo "<td>Open Gate</td>";
                                    elseif($row['action']=='close_gate_status')
                                        echo "<td>Close Gate</td>";
                                    elseif($row['action']=='water_pumped')
                                        echo "<td>Water Pumped - " . $row['action_value'] .  " </td>";
